package com.saini.recipe.bootstrap;
...
import com.saini.recipe.domain.Category;
import com.saini.recipe.domain.Difficulty;
import com.saini.recipe.domain.Ingredient;
import com.saini.recipe.domain.Notes;
import com.saini.recipe.domain.Recipe;
import com.saini.recipe.domain.UnitOfMeasure;
import com.saini.recipe.repositories.CategoryRepository;
import com.saini.recipe.repositories.RecipeRepository;
import com.saini.recipe.repositories.UnitOfMeasureRespository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes(){
		...
		//get UOMs
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRespository.findByDescription("Pinch");
        ...
        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRespository.findByDescription("Cup");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRespository.findByDescription("Pinch");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRespository.findByDescription("Ounce");
